package top.bulgat.ai.travel.plan.test;
 ...
 */
@Slf4j
public class TestSpeechTranscriber {
    private String appKey;
    private NlsClient client;

    public TestSpeechTranscriber(String appKey, String id, String secret, String url) {
        this.appKey = appKey;
    ...
    public void process(String filepath) {
        ...
        try {
           ...
           //设置vad噪音阈值参数，参数取值为-1～+1，如-0.9、-0.8、0.2、0.9。
            ...
            transcriber.stop();
            log.info("ASR latency : " + (System.currentTimeMillis() - now) + " ms");
        } catch (Exception e) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filepath = "~/java/ai-travel-planner/ai-travel-planner-app/src/test/resources/data/pcm.pcm";
        TestSpeechTranscriber demo = new TestSpeechTranscriber(appKey, id, secret, url);
